...
public class Main {
    public static void main(String[] args) {
        // Создаем объекты
        Book audioBook = new AudioBook("1984", "George Orwell", "John Smith");
        Book musical = new Musical("The Phantom of the Opera", "Andrew Lloyd Webber", "Cameron Mackintosh");
        Book movie = new Movie("Inception", "Christopher Nolan", "Emma Thomas");
